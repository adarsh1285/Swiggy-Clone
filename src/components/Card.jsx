        ...
        <div className={`${props.width} shrink-0 grow`}>
            <div className="group h-[180px] rounded-[15px] overflow-hidden relative">
                <img className="group-hover:scale-110 duration-150 object-cover w-full h-full"
                    src={"http://localhost:5000/images/" + props.image} alt="" />
                <div className="image-overlay absolute w-full h-full top-0 flex items-end p-1 text-[25px]
            ...
            <div className="flex items-center">
                <Start className="mr-2"/>{props.rating}
              <spin className="ml-2">{props.minTime} - {props.maxTime} mins</spin>
            </div>
            <div className="flex">
                {props.name}
                <br/>
